  ...
  return (
    <PageLayout>
      ...
      <section className="relative bg-gradient-to-br from-primary-600 via-primary-700 to-primary-800 text-white py-20 overflow-hidden">
        <div className="absolute inset-0 opacity-15 bg-[url('https://images.unsplash.com/photo-1450101499163-c8848c66ca85?q=80&w=1920')] bg-cover bg-center"></div>
              ...
              {certifications.map((cert, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className="mb-4">
                      <span className="inline-block bg-gold-100 text-gold-700 px-3 py-1 rounded-full text-sm font-medium">
                        {cert.category}
                      </span>
                    </div>
